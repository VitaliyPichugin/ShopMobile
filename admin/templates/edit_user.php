...
<table class="add_edit_page" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <td><input class="head-text" type="text" name="login" value="<?=htmlspecialchars($get_user['login'])?>" /></td>
        <?php else: //если редактируется свой профиль ?>
        <td><input class="head-text" type="text" name="login" value="<?=htmlspecialchars($get_user['login'])?>" disabled="" /><span class="small"> Собственный логин изменить нельзя</span></td>
        <?php endif; ?>
    </tr>
    <tr>
