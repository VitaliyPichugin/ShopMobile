 ...
 <div id="content-zakaz">
  <h2>Оформление заказа</h2>
    ...
    ?>
  <?php if($_SESSION['cart']): //проверка корзины если в ней есть товары?>
  ...
  <form method="post" action="">
    ...
    <tr>
    <td class="z_name">
      <a href="?view=product&goods_id=<?=$key ?>"><img src="<?=PRODUCT_IMG?><?=$item['img'] ?>" title="удалить товар из заказа" width="32px" /></a>
    ...
    <td class="z_bot" colspan="3" align="right"><?=$_SESSION['total_quantity'] ?> шт &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?=$_SESSION['total_sum'] ?> $</td>
    </tr>
  ...
  <div class="sposob-dostavki">
    <h4>Способы доставки:</h4>
     <?php foreach($dostavka as $key=>$item): ?>
